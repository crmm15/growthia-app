            ...
            if expiraciones:
                ...
                with st.expander("ℹ️ Interpretación del gráfico"):
                    if rol == "Comprador" and tipo_opcion == "CALL":
                        st.markdown(f"""
                - 🎯 Comprás el derecho a comprar la acción a **${strike_price:.2f}** pagando una prima de **${premium:.2f}**.
                ...
                - ⚖️ El gráfico muestra tu rentabilidad según el precio al vencimiento.
                        ...
                        st.markdown(f"""
                - 🎯 Comprás el derecho a vender la acción a **${strike_price:.2f}** pagando una prima de **${premium:.2f}**.
                ...
                - ⚖️ El gráfico refleja tu cobertura o especulación a la baja.
                        ...
                        st.markdown(f"""
                - 💰 Vendés la opción y recibís **${premium:.2f}** pero asumís la obligación de vender a **${strike_price:.2f}**.
                ...
                - 📉 Riesgo ilimitado si el precio sube mucho (a menos que tengas las acciones).
                        ...
                        st.markdown(f"""
                - 💰 Vendés la opción y te pagan **${premium:.2f}** por asumir la obligación de comprar a **${strike_price:.2f}**.
                ...
                - 🔻 Pérdida máxima: la prima.
                        ...
                        if tipo_opcion == "CALL":
                            st.markdown(f"""
                - 💵 Recibís una prima (**${premium:.2f}**) por asumir la obligación de vender a **${strike_price:.2f}**.
                ...
                - 🔒 Estrategia útil para generar ingresos si creés que la acción no superará el strike.
                            ...
                            st.markdown(f"""
                - 💵 Recibís una prima (**${premium:.2f}**) por asumir la obligación de comprar a **${strike_price:.2f}**.
